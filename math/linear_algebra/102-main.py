#!/usr/bin/env python3
"""Test for the cat_matrices function."""
...
# Nested 4D matrices concatenation
mat3 = [
    [
        [[1, 2, 3, 4], [5, 6, 7, 8]],
...
# Invalid concatenation (different shapes)
